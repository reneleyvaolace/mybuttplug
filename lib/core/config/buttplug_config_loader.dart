...
for (final config in configs) {
  ...
  print('Features: ${config.config.getStimulationType()}');
}

// Obtener todos los dispositivos Lovense
final lovenseDevices = loader.getConfigsByProtocol('lovense');
print('Dispositivos Lovense: ${lovenseDevices.length}');

// Convertir a ToyModel
final toyModel = configs.first.toToyModel();
print('ToyModel: ${toyModel.name}');
print('Motor Logic: ${toyModel.motorLogic}');
*/
