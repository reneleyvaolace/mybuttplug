...
class ConnectionManager {
  ...
  Future<Result<List<DeviceInterface>, DeviceError>> scan({
    ...
    if (_isScanning) {
      return Failure(DeviceError.alreadyConnected); // Ya está escaneando
    }
  ...
  Future<Result<DeviceInterface, DeviceError>> connect(
    ...
    DeviceInterface? device = _availableDevices[deviceId];
    ...
    if (device == null) {
      ...
      return Failure(DeviceError.notFound);
    }
  ...
  Future<Result<void, DeviceError>> disconnect(
    ...
    DeviceInterface? device = _connectedDevices[deviceId];
