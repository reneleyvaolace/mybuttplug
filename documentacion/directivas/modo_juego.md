...
## Objetivo
Integrar un mini-juego interactivo de físicas (estilo frutas rectangulares o circulares fusionables) usando el motor `flame`. Las interacciones en el juego deben traducirse a comandos hápticos precisos enviados al dispositivo LVS-8154 utilizando el protocolo rMesh/BLE actual.
